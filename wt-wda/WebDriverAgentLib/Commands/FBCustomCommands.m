...
+ (NSArray *)routes
{
  ...
  @[
    ...
    //[[FBRoute POST:@"/wda/activateApp"] respondWithTarget:self action:@selector(handleActivateAppCommand:)],
...
//+ (id<FBResponsePayload>)handleActivateAppCommand:(FBRouteRequest *)request
//{
//  NSNumber *requestedDuration = request.arguments[@"duration"];
//  NSTimeInterval duration = (requestedDuration ? requestedDuration.doubleValue : 3.);
//  NSError *error;
//  if (![request.session.testedApplication fb_deactivateWithDuration:duration error:&error]) {
//    return FBResponseWithError(error);
//  }
//  return FBResponseWithOK();
//}
