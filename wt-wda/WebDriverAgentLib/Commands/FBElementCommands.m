...
+ (NSArray *)routes
{
  ...
  @[
    ...
    [[FBRoute POST:@"/wda/dragWithRapidResp"] respondWithTarget:self action:@selector(handleDragWithRapidResp:)],
    [[FBRoute POST:@"/wda/tapWithRapidResp"] respondWithTarget:self action:@selector(handleTapWithRapidResp:)],
...
+ (id<FBResponsePayload>)handleGetWindowSize:(FBRouteRequest *)request
{
  ...
  NSLog(@"handleGetWindowSize use time =%f millisecond ", (end-start));
...
/**
 ...
 + */
+ (id<FBResponsePayload>)handleDragWithRapidResp:(FBRouteRequest *)request
{
...
/**
 ...
 + */
+ (id<FBResponsePayload>)handleTapWithRapidResp:(FBRouteRequest *)request
{
