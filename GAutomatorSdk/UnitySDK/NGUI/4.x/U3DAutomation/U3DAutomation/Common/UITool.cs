...
namespace WeTest.U3DAutomation
{
    ...
    class UIBase
    {
        ...
        public static Camera FindBestCamera(GameObject obj)
        {
            ...
            Logger.d("Cameras size " + cameras.Count);
        ...
        public Rectangle GetBoundByCollider(Camera cm, GameObject obj)
        {
            ...
            return GetBoundByCollider(cm, obj, true);
        } 
        ...
        public Rectangle GetBoundByCollider(Camera cm, GameObject obj,Boolean ignoreZ)
        {
            ...
            if (obj.activeInHierarchy && collider2d != null && collider2d.enabled)
            {
                return CoordinateTool.WorldBoundsToScreenRect(cm, collider2d.bounds, ignoreZ);
            }
        ...
        public Rectangle GetGUIBound(Camera cm, GameObject obj)
        {
            ...
            if ((rect =GetBoundByCollider(cm,obj)) != null)
            {
                return rect;
            }
            else if ((rect = GetBoundByRender(cm, obj)) != null)
            {
                return rect;
            }
