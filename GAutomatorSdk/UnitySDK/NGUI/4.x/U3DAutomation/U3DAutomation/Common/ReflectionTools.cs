        ...
        */
        ...
        private static void loadAssembly(String path)
        {
            ...
            catch (System.Exception ex)
            {
                ...
                Debug.Log(ex);
                throw new Exception("load "+path+" library failed.");
            }
        }
        ...
        public static void testLibInit()
        {
            ...
            //else if(RuntimePlatform.IPhonePlayer==Application.platform){//apple will not allow to do this
            //    loadAssembly(Application.persistentDataPath + "gametestlib.dll");
            //}
